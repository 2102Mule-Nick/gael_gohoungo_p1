...
public class AppConfig {
	...
	public static final String DATASOURCE_URL = 
			"jdbc:postgressql://" + 
	        System.getenv("FlightBooking_DB_URL") +
	        ":5432/" +
	        System.getenv("FlightBooking_DB_NAME") +
	        "?";
	public static final String DATASOURCE_DRIVERNAME = "org.postgresql.Driver";
	public static final String DATASOURCE_USERNAME = System.getenv("FlightBooking_DB_USERNAME");
	public static final String DATASOURCE_PASSWORD = System.getenv("FlightBooking_DB_PASSWORD");
	public static final String DATASOURCE_SCHEMA = "FlightBooking";
